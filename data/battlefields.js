...
window.EOL.battlefields = [
  {
    ...
    rules: [
      'Only front-row heroes may use Basic Skills.',
      'Back-row heroes must spend Signature Skills.',
    ],
  ...
  },
  {
    ...
    rules: ['Back-row heroes deal +15% damage.', 'Front-row heroes have -15% DEF.'],
  ...
  },
  {
    ...
    draft: 'Cheap heroes shine; expensive signatures become a liability.',
    energyPerRound: -10,
  },
  {
    id: 'colosseum',
  ...
  },
  {
    ...
    draft: 'Skill-centric heroes spike; opening timing becomes a mind game.',
  ...
  },
  {
    ...
    rules: [
      'A lethal blow leaves the hero on 1 HP instead of killing them.',
      'Once per hero. The next blow finishes the job.',
    ],
    draft: 'Every hero effectively survives one extra hit, so burst loses to sustained pressure.',
    spiritReprieve: true,
  },
  {
    id: 'ancient-ruins',
  ...
  },
  {
    ...
    rules: ['Heroes below 50% HP deal +25% damage.'],
